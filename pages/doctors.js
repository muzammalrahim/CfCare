                            ...
                            <div className="col-sm-6 col-lg-6">
                                <div className="doctor-search-item">
                                    <div className="form-group">
                                        ...
                                        <label>Search</label>   
                                        <input onChange={e => setNamee(e.target.value)} value={namee} type="text" className="form-control" placeholder="Doctor Name" />
                                    </div>
                            ...
                            <div className="col-sm-6 col-lg-6">
                                <div className="doctor-search-item">
                                    <div className="form-group">
                                        ...
                                        <select onChange={e =>setCategorry(e.target.value)} className="form-control">
                                            <option></option>
                    ...
                    <div className="row">
                        {
                         doctorsList.filter((val) => {
                             ...
                             else if (val.name.toLocaleLowerCase().includes(namee.toLocaleLowerCase()) && val.categoryy.toLocaleLowerCase().includes(categorry.toLocaleLowerCase())){
                                 return val
                             }
                         }).map((val,id)=>(
