            ...
            <div className="col-md-6 col-lg-4">
              <div className="blog-item">
                ...
                <div className="blog-bottom">
                  <h3>
                    <Link href="/blog-details">
                      <a>We always give the best from us</a>
                    </Link>
                  </h3>
                  <p>
                    Lorem ipsum is dolor sit amet, csectetur adipiscing elit,
            ...
            <div className="col-md-6 col-lg-4">
              <div className="blog-item">
                ...
                <div className="blog-bottom">
                  <h3>
                    <Link href="/blog-details">
                      <a>Be aware about the coronavirus</a>
                    </Link>
                  </h3>
                  <p>
                    Lorem ipsum is dolor sit amet, csectetur adipiscing elit,
            ...
            <div className="col-md-6 col-lg-4">
              <div className="blog-item">
                ...
                <div className="blog-bottom">
                  <h3>
                    <Link href="/blog-details">
                      <a>No one find any medicines to prevent evolovirus</a>
                    </Link>
                  </h3>
                  <p>
                    Lorem ipsum is dolor sit amet, csectetur adipiscing elit,
            ...
            <div className="col-md-6 col-lg-4">
              <div className="blog-item">
                ...
                <div className="blog-bottom">
                  <h3>
                    <Link href="/blog-details">
                      <a>Thailand is trying to make vaccine of coronavirus</a>
                    </Link>
                  </h3>
                  <p>
                    Lorem ipsum is dolor sit amet, csectetur adipiscing elit,
            ...
            <div className="col-md-6 col-lg-4">
              <div className="blog-item">
                ...
                <div className="blog-bottom">
                  <h3>
                    <Link href="/blog-details">
                      <a>Already 1932 people have died in China</a>
                    </Link>
                  </h3>
                  <p>
                    Lorem ipsum is dolor sit amet, csectetur adipiscing elit,
            ...
            <div className="col-md-6 offset-md-3 offset-lg-0 col-lg-4">
              <div className="blog-item">
                ...
                <div className="blog-bottom">
                  <h3>
                    <Link href="/blog-details">
                      <a>30+ countries have affected by coronavirus</a>
                    </Link>
                  </h3>
                  <p>
                    Lorem ipsum is dolor sit amet, csectetur adipiscing elit,
